...
public class App extends Application {
    ...
    public void start(Stage stage) throws Exception {
        ...
        Image image = new Image(App.class.getResource("/images/accounting.png").toExternalForm());
        ...
        */
        ...
        BorderPane borderPane = new BorderPane();
        Text text = new Text("This is some text. Hello Mridul, Hello Mridul, Hello Mridul");
